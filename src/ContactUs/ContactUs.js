      ...
      <div className="min-h-screen p-10 flex flex-col items-center">
        ...
        <div className="container mx-auto p-4 flex flex-col items-center md:flex-row">
          <div className="info flex-1 p-4 text-center md:text-left">
            <h1 className="text-2xl font-bold mb-4 flex-row">
            ...
            <p className="mb-4">✉ sociablespot@gmail.com</p>
            <p className="mb-4">📍 Ahmedabad, Gujarat</p>
          </div>
          <div className="contact-form flex-1 p-4 bg-green-300 rounded-md mt-8 md:mt-0 md:ml-4">
            <form className="space-y-4">
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  className="px-6 py-2 bg-white font-medium text-gray-700 rounded-full"
                >
                  Submit
                </button>
              </div>
        ...
        <div className="text-center text-black text-xl font-semibold mt-10 mb-8">
